...
packet[0] = { len: Infinity, parser: packet.compressed };
packet[6] = { len: 300, parser: packet.interact };
packet[7] = { len: 68, parser: packet.hit };
packet[8] = { len: 40, parser: packet.stealth };
packet[9] = { len: 112, parser: packet.shoot };
packet[10] = { len: Infinity, parser: packet.chat };
packet[11] = { len: 8, parser: packet.readChunk };
packet[12] = { len: 8, parser: packet.unkChunk };
packet[17] = { len: 4, parser: packet.version };
